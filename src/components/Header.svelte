...
<style>
  ...
  .container {
    ...
    background-image: url("/svg/bg-red.png");
  ...
  .banner_container {
    ...
    margin-right: auto;
    position: relative;
    top: var(--banner-small);
  }

  .panther_container {
    height: var(--panther-small);
    width: var(--panther-small);
    position: absolute;
    left: 0;
    right: 0;
    margin-left: auto;
  ...
  .panther_container:hover {
    height: 160px;
    width: 160px;
  }

  .panther_container:hover .magic {
    display: block;
  }

  .panther_container:hover .white {
    display: none;
  }
...
<header class="container">
  <a class="link_as_container" href="/" aria-label="Navigate to home page">
    <div class="panther_container">
      <div class="white">
        <White />
      </div>
      <div class="magic">
